<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="NozemenInfotech.Home" %>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text">
                                <h2 data-animation="fadeInUp" data-delay="300ms"><span>Nozemen Infotech Bringing ICT To Your</span><br>Door step</h2>
                                <h4 data-animation="fadeInUp" data-delay="500ms">Really  : <span>Affordable</span></h4>
            ...
            <div class="single-slide">
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text">
                                <h2 data-animation="fadeInUp" data-delay="300ms"><span>Website Development</span><br></h2>
                                <h4 data-animation="fadeInUp" data-delay="500ms">Business Automation <span></span></h4>
                                <a href="#" class="btn pixel-btn mt-50" data-animation="fadeInUp" data-delay="700ms">View Project</a>
                            </div>
                        </div>
                    </div>
...
<%--               <div style="width:50%; display: inline-block; float:left; margin-right: 10px; padding-top: 40px;"> --%>

              
 <div class="css-section">
     <h1>WEBSITE DESIGN AND ICT COMPANY IN BENIN CITY
         EDO STATE
</h1>
<p>
Nozemen InfoTech is an innovative website Design and ICT company based in Benin, Nigeria.
    At Nozemen InfoTech,we work as a team to create wonderful and inviting and exciting digital experience.
Whenit comes to offering ICT training, we go down to earth to help you acquire the various skills.
    We help businesses to leverage technology to save cost and increase profit.
Delivering the best is our almost commitment and delight.
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center wow fadeInUp" data-wow-delay="100ms">
                        <h2>Made by Nozemen Infotech</h2>
                        <img src="C:\Users\Osazee\source\repos\NozemenInfotech\NozemenInfotech\NOZEME_LOGOS.jpg2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
